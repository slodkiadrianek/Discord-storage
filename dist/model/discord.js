import { Client, GatewayIntentBits, ChannelType, AttachmentBuilder, IntentsBitField, } from "discord.js";
...
export async function createThreadInChannel(messageName, filePaths) {
    try {
        ...
        if (channel.type === ChannelType.GuildText) {
            ...
            if (threadChannel && threadChannel.isThread()) {
                const files = filePaths.map((filePath) => new AttachmentBuilder(filePath)
